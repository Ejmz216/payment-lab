...
export const lessonsEs: Record<string, LessonTranslation> = {
  ...
  'payment-fundamentals': {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Estos términos se solapan en el lenguaje cotidiano de la industria, pero no son sinónimos exactos. Payment system es el arreglo amplio; payment scheme enfatiza el reglamento; payment rail es una forma informal de referirse a la ruta o infraestructura subyacente; y payment network depende del contexto. La lección dedicada a Sistemas de Pago enseña a separarlos.',
      },
    ],
    commonConfusion: [
      {
  ...
  'payment-systems': {
    title: 'Sistemas y Redes de Pago',
    subtitle: 'La infraestructura, las reglas, los participantes y el tiempo detrás de un pago',
    whyItMatters: 'Términos como payment system, rail, scheme y network suelen mezclarse. Separarlos te ayuda a identificar quién participa, cuáles reglas aplican, dónde se liquida el valor y por qué un pago puede completarse en segundos mientras otro atraviesa varias ventanas de procesamiento.',
    objectives: [
      'Distinguir payment system, payment scheme, payment rail y payment network sin tratarlos como sinónimos exactos.',
      'Identificar al cliente, los proveedores de servicios de pago, la infraestructura y el operador en un pago doméstico simple.',
      'Explicar cómo los cutoffs, lotes, días bancarios, ventanas de settlement y posting pueden agregar tiempo.',
      'Comparar un flujo programado ilustrativo con un flujo de pago instantáneo de extremo a extremo.',
      'Relacionar el comportamiento público 24/7 y en tiempo real del SGPI dominicano con el modelo general sin adivinar procesos internos.',
    ],
    mentalModel: 'Haz cuatro preguntas por separado: ¿Qué arreglo mueve el pago? ¿Cuál reglamento lo gobierna? ¿Quién está conectado? ¿Cuándo ocurren realmente clearing, settlement y el crédito?',
    sections: [],
    blocks: [
      {
        type: 'explanation',
        heading: '¿Una red de pagos es lo mismo que un payment rail?',
        body: 'No exactamente. Payment rail es una forma informal de referirse a la ruta o infraestructura por la que se procesan las instrucciones y el valor. Payment network puede significar el conjunto de participantes conectados y sus relaciones de comunicación, pero algunas organizaciones también lo usan para un esquema con marca o para todo el sistema de pagos. Cuando alguien diga network, pregunta si se refiere a la infraestructura, las reglas, los participantes o al arreglo completo.',
        badge: 'reference',
      },
      {
        type: 'comparison',
        heading: 'Tres capas que suelen comprimirse en una sola palabra',
        intro: 'Los límites pueden variar por jurisdicción y organización. Usa estas preguntas como modelo de trabajo y luego verifica la terminología del sistema específico que estudias.',
        keyQuestionLabel: 'Pregunta',
        examplesLabel: 'Incluye',
        notThisLabel: 'No lo reduzcas a',
        badge: 'reference',
        items: [
          {
            id: 'payment-system',
            label: 'Payment system',
            keyQuestion: '¿Cuál arreglo completo permite transferir fondos?',
            summary: 'Un arreglo amplio que combina participantes, procedimientos, reglas y la infraestructura usada para transferir fondos.',
            examples: ['participantes', 'procedimientos', 'clearing', 'settlement'],
            notThis: 'Solo el enlace de comunicación que transporta un mensaje.',
            tone: 'infrastructure',
          },
          {
            id: 'payment-scheme',
            label: 'Payment scheme',
            keyQuestion: '¿Cuál reglamento define la participación y el comportamiento permitido?',
            summary: 'Los roles, elegibilidad, reglas operativas, tiempos, responsabilidades y requisitos de uso acordados para el servicio.',
            examples: ['elegibilidad', 'timeouts', 'límites', 'responsabilidad'],
            notThis: 'Necesariamente la plataforma tecnológica o el activo de settlement.',
            tone: 'scheme',
          },
          {
            id: 'payment-rail',
            label: 'Payment rail',
            keyQuestion: '¿Cuál ruta o infraestructura subyacente transporta el pago?',
            summary: 'Término informal de la industria para una infraestructura o canal, como un rail instantáneo, ACH o RTGS.',
            examples: ['rail instantáneo', 'rail ACH', 'rail RTGS'],
            notThis: 'Un término universalmente estandarizado con un único límite formal.',
            tone: 'neutral',
          },
        ],
      },
      {
        type: 'payment-flow',
        heading: 'Actores en una ruta de pago doméstica simple',
        badge: 'simplified-model',
        actors: [
          { id: 'customer-a', label: 'CUSTOMER_A', role: 'Pagador / Debtor', kind: 'party' },
          { id: 'bank-a', label: 'BANK_A', role: 'PSP originador / Debtor Agent', kind: 'agent' },
          { id: 'payment-system', label: 'PAYMENT_SYSTEM', role: 'Servicio de clearing / settlement', kind: 'infrastructure' },
          { id: 'bank-b', label: 'BANK_B', role: 'PSP receptor / Creditor Agent', kind: 'agent' },
          { id: 'customer-b', label: 'CUSTOMER_B', role: 'Beneficiario / Creditor', kind: 'party' },
        ],
        steps: [
          { from: 'customer-a', to: 'bank-a', label: 'autoriza', status: 'active' },
          { from: 'bank-a', to: 'payment-system', label: 'envía', status: 'active' },
          { from: 'payment-system', to: 'bank-b', label: 'procesa', status: 'active' },
          { from: 'bank-b', to: 'customer-b', label: 'acredita', status: 'success' },
        ],
      },
      {
        type: 'explanation',
        heading: 'El esquema y el operador no son clientes adicionales',
        body: 'El pagador y el beneficiario son partes. BANK_A y BANK_B son proveedores de servicios de pago y agentes ISO 20022 en este flujo simplificado. El operador administra la infraestructura del sistema, mientras el esquema define las reglas aplicables. Una misma organización puede desempeñar más de un rol, pero los roles siguen siendo conceptualmente distintos. Un agente de settlement o banco central también puede mantener las cuentas o el activo usado para liquidar entre participantes.',
        badge: 'simplified-model',
      },
      {
        type: 'timing-comparison',
        heading: 'De dónde sale el tiempo de espera',
        intro: 'Este ejemplo de un viernes por la tarde contrasta un diseño programado y por lotes con un pago instantáneo de extremo a extremo. Es un modelo educativo, no una promesa sobre todos los sistemas.',
        badge: 'simplified-model',
        lanes: [
          {
            id: 'scheduled',
            label: 'Flujo programado o por lotes',
            summary: 'El procesamiento avanza mediante días bancarios elegibles, cutoffs y ventanas de servicio.',
            availability: 'Ventanas operativas programadas',
            elapsed: 'Puede cruzar varios días',
            tone: 'scheduled',
            stages: [
              {
                id: 'scheduled-initiation',
                label: 'El cliente autoriza',
                timing: 'VIE 18:10',
                description: 'BANK_A registra la solicitud después del cutoff relevante del servicio.',
              },
              {
                id: 'scheduled-wait',
                label: 'Espera una ventana elegible',
                timing: 'EN COLA',
                description: 'Un fin de semana o feriado puede posponer el siguiente proceso bancario aunque el mensaje pueda viajar electrónicamente.',
                wait: true,
              },
              {
                id: 'scheduled-batch',
                label: 'Lote del originador',
                timing: 'PRÓXIMO DÍA BANCARIO',
                description: 'BANK_A valida y envía la instrucción en un archivo o ciclo de procesamiento programado.',
              },
              {
                id: 'scheduled-settlement',
                label: 'Ventana de clearing y settlement',
                timing: 'VENTANA POSTERIOR',
                description: 'El sistema determina y liquida obligaciones según su propio diseño de settlement.',
              },
              {
                id: 'scheduled-posting',
                label: 'El PSP receptor registra los fondos',
                timing: 'DESPUÉS DE RECIBIR',
                description: 'BANK_B aplica su procesamiento y pone los fondos a disposición de CUSTOMER_B cuando las reglas y la evidencia aplicables lo permiten.',
              },
            ],
          },
          {
            id: 'fast',
            label: 'Pago instantáneo de extremo a extremo',
            summary: 'Los mismos puntos de control de negocio se comprimen dentro de un servicio continuamente disponible.',
            availability: 'Disponibilidad cercana a 24/7',
            elapsed: 'Normalmente segundos',
            tone: 'fast',
            stages: [
              {
                id: 'fast-initiation',
                label: 'El cliente autoriza',
                timing: 'VIE 18:10',
                description: 'BANK_A recibe la solicitud mientras el servicio de pago instantáneo está disponible.',
              },
              {
                id: 'fast-validation',
                label: 'Validar y decidir',
                timing: '+ MILISEGUNDOS',
                description: 'Las validaciones de cuenta, límites, fraude y cumplimiento deben ejecutarse bajo restricciones de tiempo exigentes.',
              },
              {
                id: 'fast-processing',
                label: 'El sistema procesa el pago',
                timing: '+ SEGUNDOS',
                description: 'El enrutamiento y los eventos asociados a clearing y settlement ocurren según el diseño del sistema específico.',
              },
              {
                id: 'fast-credit',
                label: 'El PSP receptor confirma y acredita',
                timing: 'SEGUNDOS',
                description: 'BANK_B recibe el resultado y pone fondos finales a disposición de CUSTOMER_B según las reglas aplicables.',
              },
            ],
          },
        ],
        conclusion: 'La diferencia normalmente no es que un mensaje electrónico necesite días para cruzar una red. La espera se acumula en límites de procesamiento: cutoffs, lotes, días bancarios, ciclos de settlement, intermediarios y posting. Un diseño instantáneo elimina o comprime muchas de esas esperas, pero settlement y crédito en cuenta siguen siendo eventos distintos que deben probarse.',
      },
      {
        type: 'explanation',
        heading: '¿Por qué un pago podía tardar tres o más días?',
        body: 'Un flujo heredado o transfronterizo puede atravesar varias instituciones, monedas y procesos programados. Perder un cutoff puede aplazar el envío; un fin de semana o feriado puede retrasar el siguiente día bancario; clearing y settlement pueden ocurrir en ventanas posteriores; y un intermediario o la institución receptora puede agregar validación, manejo de excepciones o tiempo de posting. Esas esperas pueden acumularse. Sin embargo, no memorices "pago tradicional = 3-5 días": muchos pagos modernos por lotes liquidan el mismo día o dentro de un día bancario.',
        badge: 'reference',
      },
      {
        type: 'prediction',
        context: 'CUSTOMER_A autoriza una transferencia el viernes después del cutoff. El lunes siguiente es feriado bancario.',
        question: '¿Qué explica mejor que un flujo programado quizá no avance hasta el martes?',
        options: [
          { id: 'a', label: 'Los mensajes electrónicos necesitan físicamente cuatro días para viajar', correct: false },
          { id: 'b', label: 'La próxima ventana elegible de procesamiento bancario es el martes', correct: true },
          { id: 'c', label: 'ISO 20022 prohíbe los pagos de fin de semana', correct: false },
          { id: 'd', label: 'Todo rail tradicional tiene una espera obligatoria de cuatro días', correct: false },
        ],
        explanation: 'La demora viene del calendario operativo de este ejemplo, no de la velocidad física del mensaje ni de ISO 20022. Otros sistemas pueden ofrecer procesamiento el mismo día, al día siguiente o continuo.',
      },
      {
        type: 'explanation',
        heading: 'Caso público dominicano: SGPI',
        body: 'El Reglamento SIPARD público describe al SGPI como una plataforma electrónica administrada por el BCRD que permite transferencias y pagos en tiempo real, las 24 horas del día y todos los días del año. Eso permite clasificar el comportamiento público de su servicio como pago instantáneo. Por sí solo, no establece la arquitectura interna de una institución, su mapeo exacto de mensajes ISO 20022 ni cuál evento técnico usa cada participante como evidencia de settlement o crédito.',
        badge: 'public-scheme',
      },
      {
        type: 'quick-check',
        question: 'Una interfaz muestra "enviado" en dos segundos. ¿Eso prueba por sí solo el settlement entre participantes y el crédito en la cuenta del beneficiario?',
        options: [
          { id: 'a', label: 'Sí, la velocidad prueba ambos eventos', correct: false },
          { id: 'b', label: 'No, cada evento necesita la evidencia definida por el sistema y la institución', correct: true },
        ],
        explanation: 'Una experiencia rápida no convierte la recepción, aceptación, settlement y crédito en cuenta en un solo evento. Rastrea la evidencia de cada límite.',
      },
    ],
    commonConfusion: [
      {
        title: 'Tradicional no siempre significa de tres a cinco días',
        explanation: 'Los sistemas modernos por lotes pueden ofrecer settlement el mismo día o al siguiente día bancario. El tiempo depende del servicio, hora de envío, calendario operativo, diseño de settlement, intermediarios y estado de excepciones.',
      },
      {
        title: 'La transmisión rápida no identifica el modelo de settlement',
        explanation: 'Un sistema puede intercambiar mensajes rápidamente mientras usa un mecanismo de settlement específico de su diseño. Verifica finalidad, disponibilidad de fondos y evidencia en las reglas aplicables.',
      },
    ],
  },
  'fast-payments': {
